...
public class InternalJNI {
  ...
  // change to default
  static native int setup(int executionPath);
  ...
  static native int compressByteBuff(ByteBuffer src, int srcOffset, int srcLen, ByteBuffer dest, Boolean retry, int retryCount);
  static native int decompressByteBuff(ByteBuffer src, int srcOffset, int srcLen, ByteBuffer dest,Boolean retry, int retryCount);
}